...
uses SysUtils,Classes,VCL.Graphics,Forms,Controls,StdCtrls,Dialogs,Buttons,
     ExtCtrls,ComCtrls,Global,ImgList,ToolWin,Messages,System.ImageList,UITypes,
     Winapi.Windows,Vcl.Grids,System.Actions,Vcl.ActnList,Printers,StrUtils,
     Vcl.Imaging.pngimage,Vcl.Menus,adpMRU, IdBaseComponent, IdComponent,
